...
namespace GeneralStore.MVC.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TransactionId,CustomerId,ProductId,PurchaseQty,CreatedUtc")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TransactionId,CustomerId,ProductId,PurchaseQty,CreatedUtc")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
